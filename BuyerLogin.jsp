									...
									<div class="row">
										...
										<div class="col-sm-4">
											<form action="ValidateBuyerLogin.jsp" method="post">
												<p style="color: rgb(255, 255, 255);font-size:1.9em;"><b>BuyerId:</b>
												</p><input autocomplete="off" class="form-control" type="text"
													name="buyerId" placeholder="Enter BuyerId" required="">
												<br><br>

												<p style="color: rgb(255, 255, 255);font-size:1.9em;"><b>Password:</b>
												</p><input autocomplete="off" class="form-control" type="password"
													name="buyerPassword" placeholder="Enter Your Password." required="">
												<br><br>
