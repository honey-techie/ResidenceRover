										...
										<div class="row">
											...
											<div class="col-sm-4">
												<% if(session.getAttribute("transactionFailed")!=null) { String
													s=(String) session.getAttribute("transactionFailed");
													session.removeAttribute("transactionFailed"); if(s.equals("true")) {
													%>
													...
													<% } else { %>
														...
														<% } } %>
															...
															<form action="ValidateULS.jsp">
																...
																HouseId :
																<input type="number" name="houseId" min="0"
																	class="form-control" required=""
																	placeholder="houseId">
																<br><br>
																TransactionId :
																<input type="number" name="transactionId" min="0"
																	class="form-control" required=""
