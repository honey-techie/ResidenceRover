						...
						<%@ page errorPage="error.jsp" %>
							<%@ page session="true" %>
									...
									<div class="container-fluid">
										...
										<ul class="nav navbar-nav">
											...
											<% if(session.getAttribute("buyerId")!=null ||
												session.getAttribute("sellerId")!=null ||
								...
								<% Class.forName("com.mysql.jdbc.Driver").newInstance(); try( Connection
									conn=DriverManager.getConnection(url,user,pass); Statement
									stmt=conn.createStatement(); ) { ResultSet rset=stmt.executeQuery("select * from
									agents order by agent_id"); ResultSetMetaData rsmd=rset.getMetaData(); int
