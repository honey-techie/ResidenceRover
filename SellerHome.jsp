	...
	<%@ page session="true" %>
		<%@ include file="connection.jsp" %>
			<% // for revalidation after logout.
				...
				response.sendRedirect("AgentHome.jsp"); } else if(buyerId!=null) {
				response.sendRedirect("BuyerHome.jsp"); } else if(employeeId!=null) {
				response.sendRedirect("EmployeeHome.jsp"); } else if(sellerId==null) {
							...
							<div class="d-flex justify-content-center align-items-center ">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										...
										<button type="button" onclick="location.href='UploadNewHouse.jsp'"
											class="btn  btn-lg btn-block">SELL/RENT A HOUSE</button>

										<br><br>

										<button type="button" onclick="location.href='ViewSellerHouses.jsp'"
											class="btn  btn-lg btn-block">VIEW HOUSES</button>
