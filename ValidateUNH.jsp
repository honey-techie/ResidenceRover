			...
			<%@ include file="connection.jsp" %>
				<%@ page import="java.util.*" %>
					...
					<% SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd"); String date=sdf.format(new Date());
						...
						<% Connection conn=null; try { conn=DriverManager.getConnection(url,user,pass); Statement
							stmt1=conn.createStatement(); ResultSet rset1=stmt1.executeQuery("select agent_id from
							agents"); ArrayList<String> agentIds = new ArrayList<>();
								while(rset1.next()) {
