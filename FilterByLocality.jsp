					...
					<body>
						...
						<div class="container">
							...
							<div class="d-flex justify-content-center align-items-center ">
							    ...
							    <input type="text" autocomplete="off" class="form-control" name="city" placeholder="Enter City Name" required="" />
											...
											<select name="city">
												<% try(Connection conn=DriverManager.getConnection(url,user,pass);
													...
													rset=stmt.executeQuery("select distinct city from house");
													while(rset.next()) { out.print("<option>"+rset.getString(1)+"
													</option>");
													}
													}
													catch(Exception e)
											...
											<br><br>
											<label>Type : </label>
											<input type="radio" name="type" value="buy" required=""> <span
								...
								<% if(request.getParameter("type")!=null) { out.println("<br>
									<h4>"+"results for \'" +request.getParameter("city") + "\'" +" -
										\'"+request.getParameter("type")+"\'" + "</h4>");
									...
									{
									query = "select
									house_id,agent_name,agents.contact_number,street_name,apt_no,sale_price,no_bedrooms,specificatons
									from house natural join agents where sale_status = \'N\' and (rent_status is null or
									rent_status = \'N\') and city = ?";
									...
									{
									query = "select
									house_id,agent_name,agents.contact_number,street_name,apt_no,rent_price,no_bedrooms,specificatons
									from house natural join agents where (rent_status = \'N\') and city = ?";
