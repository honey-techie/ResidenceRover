	...
	<%@ page session="true" %>
		<%@ include file="connection.jsp" %>
			<% // for revalidation after logout.
				...
				buyerId=(String)session.getAttribute("buyerId"); if(agentId!=null) {
					...
					<section id="Buyer-Home">
						<div class="container">
							...
							<div class="d-flex justify-content-center align-items-center ">
								...
								<div class="row">
									<div class="col-sm-3">
										<button type="button" onclick="location.href='FilterByRange.jsp'"
											class="btn btn-primary  btn-block">FILTER BY RANGE</button>

										<br> <br>

										<button type="button" onclick="location.href='FilterByLocality.jsp'"
											class="btn btn-primary  btn-block">FILTER BY LOCALITY</button>
						...
						<br> <br>
						 ...
						 -->
										...
										<button type="button" onclick="location.href='BuyerTransactionHistory.jsp'"
											class="btn btn-primary  btn-block">TRANSACTION HISTORY</button>
