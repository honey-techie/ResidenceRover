<%@ page errorPage="error.jsp" %>
	<% // redirection goes here. // for revalidation after logout.
		...
		employeeId=(String)session.getAttribute("employeeId"); if(sellerId!=null) {
		response.sendRedirect("SellerHome.jsp"); } else if(buyerId!=null) { response.sendRedirect("BuyerHome.jsp"); }
		else if(agentId!=null) { response.sendRedirect("AgentHome.jsp"); } else if(employeeId==null) {
