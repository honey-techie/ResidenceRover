	...
	<%@ page import="java.sql.*" %>
		<%@ include file="connection.jsp" %>
			<% // for revalidation after logout.
				...
				employeeId=(String)session.getAttribute("employeeId"); if(employeeId==null) {
				...
				<body>
					...
					<% try( Connection conn=DriverManager.getConnection(url,user,pass); Statement
						stmt=conn.createStatement(); ) { ResultSet rset=stmt.executeQuery("select * from buyer order by
						buyer_id"); ResultSetMetaData rsmd=rset.getMetaData(); int columnCount=rsmd.getColumnCount(); %>
						<br><br><br>
