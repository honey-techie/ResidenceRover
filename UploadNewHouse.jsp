				...
				<%@ page import="java.util.*" %>
					...
					<% SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd"); String date=sdf.format(new Date()); %>
						...
						<% // for revalidation after logout.
							...
							if(buyerId!=null) { response.sendRedirect("BuyerHome.jsp"); } else if(agentId!=null) {
														...
														<% } else { %>
															...
															<% } } %>
																...
																<form action="ValidateUNH.jsp">
																	...
																	City :
																	<input type="text" name="city" maxlength="39"
																		class="form-control" required=""
																		placeholder="City name..">
																	<br><br>
																	Street :
																	<input type="text" name="street" maxlength="39"
																		class="form-control" required=""
																		placeholder="Street name..">
																	<br><br>
																	House Number :
																	<input type="text" name="houseNumber" maxlength="39"
																		class="form-control" required=""
																	...
																	<input type="text" name="specifications"
																		...
																		placeholder="other specifications if any..">
																	<br><br>
																	<label style="font-size:17px">Type : </label>
																	<select name="type">
																		<option value="sale">Sale</option>
																		<option value="rent">Rent</option>
																		<option value="saleandrent">Sale and Rent
																		</option>
																	</select>
																	<br><br><br>
