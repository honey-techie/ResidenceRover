					...
					<section id="seller-reg">
						<div class="container">
							...
							<div class="d-flex justify-content-center align-items-center ">
								<div class="row">
									<div class="col-sm-4">
										<h3 style="color:rgb(0, 0, 0)"><b>SELLER REGISTER</b></h3>
										<hr>
									</div>
								</div>
								<div class="row">
												...
												<% } else if(session.getAttribute("id")!=null) { %>
													<% String id=(String)session.getAttribute("id"); %>
														<% session.removeAttribute("id"); %>
															<h5 style="color:rgb(255, 33, 12);">Registration Successful,
																Your Id:
																<%=id%>
															</h5>
															<% } %>
																...
																<form action="ValidateSellerRegister.jsp" method="get">
																	<p style="color:rgb(0, 0, 0);font-size:1.9em;">
																		<b>Seller
																			Name:</b>
																	</p> <input autocomplete="off" class="form-control"
																		type="text" name="sellerName"
																	...
																	<input autocomplete="off" class="form-control"
																		type="password" name="sellerPassword"
																		pattern=".{8,}"
