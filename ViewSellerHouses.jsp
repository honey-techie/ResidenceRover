		...
		<%@ include file="connection.jsp" %>
			<%@ page import="java.sql.*" %>
				<% // for revalidation after logout.
					...
					response.sendRedirect("BuyerHome.jsp"); } else if(agentId!=null) {
					...
					<body>
						...
						<div class="container">
							...
							<% { try( Connection conn=DriverManager.getConnection(url,user,pass); ) { String query ;
								ResultSet rset ; PreparedStatement stmt;
								...
								; stmt=conn.prepareStatement(query); stmt.setString(1,sellerId);
								rset=stmt.executeQuery(); ResultSetMetaData rsmd=rset.getMetaData(); int
